...
class Benchmarker(Controller):
    ...
    def run(self, boxes=False, hi_res=False, passes="none", png=False, transforms=False, rigidbodies=False,
            collisions=False, bounds=False, size=512, junk=0, images=False, id_colors=False, id_grayscale=False,
        ...
        commands = [{"$type": "set_render_quality",
                    ...
                    {"$type": "set_img_pass_encoding",
                     "value": png},
                    TDWUtils.create_empty_room(30, 30)]  # 30
...
if __name__ == "__main__":
    ...
    # Run the benchmark.
    b = Benchmarker(launch_build=True, check_version=True)
    # b.start()
