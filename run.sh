...
#python tdw_physics/target_controllers/dominoes.py @/home/htung/Documents/2021/human-physics-benchmarking/stimuli/generation/pilot-dominoes/pilot_dominoes_4mid_tdwroom/commandline_args.txt --dir data/dominoes/pilot_dominoes_4mid_tdwroom  --save_meshes --num 100 --height 128 --width 128 --mscale "0.1,0.5,0.25"
