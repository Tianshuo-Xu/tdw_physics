...
#
#
#for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_*big_target_*
#for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_*zone_jitter_*
# do
# 	num_multiplier=5.9
#     echo $entry
...
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_it2_collision_non-sphere_box_2_dis_2_occ*
# do
# 	num_multiplier=8.33
#     echo $entry
#     IFS='/' read -r -a array <<< "$entry"
...
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_it2_collision_tiny_ball_box_2_dis_2_occ
# do
# 	num_multiplier=8.33
#     echo $entry
#     IFS='/' read -r -a array <<< "$entry"
...
for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/*big_target*
do
	num_multiplier=0.6
    echo $entry
    IFS='/' read -r -a array <<< "$entry"
...
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/*simple*
# do
# 	num_multiplier=0.42
#     echo $entry
#     IFS='/' read -r -a array <<< "$entry"
