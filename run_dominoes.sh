...
#
#
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_dominoes_[^4]*
# do
# 	num_multiplier=7.25
#     echo $entry
...
for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_dominoes_[^0-9]*
do
	num_multiplier=0.725
    echo $entry
    IFS='/' read -r -a array <<< "$entry"
    arg_name=${array[-1]}
    echo ">>>>>>>>>>>>>>>"
...
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_*
# do
# 	num_multiplier=3.62
#     echo $entry
#     IFS='/' read -r -a array <<< "$entry"
...
# for entry in "c:/cygwin64/home/hsiaoyut/2021/human-physics-benchmarking/stimuli/generation/pilot-"$sc_name/pilot_*[^4]*
# do
# 	num_multiplier=0.37
#     echo $entry
#     IFS='/' read -r -a array <<< "$entry"
