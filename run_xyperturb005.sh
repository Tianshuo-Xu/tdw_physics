...
do
    ...
    echo "==============="
    echo $num_multiplier
    $python_py $controller_py @$entry/commandline_args.txt --testing_noimg_data_mode --inject_noise_to_initial 0.05 --is_perturb --height 64 --width 64  --dir "D:/hsiaoyut/tdw_physics/pe_data/xy_perturb0.05/"$sc_name/$arg_name/$group
done
