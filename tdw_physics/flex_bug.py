...
class FlexFluids(Controller):
    ...
    def trial(self, fluid_name: str) -> None:
        ...
        self.communicate([{"$type": "create_flex_container",
                          ...
                          #11 out of 13 models are FLEX-enabled
                          #['prim_cone', 'prim_cube', 'cloth_1meter_square', 'prim_cyl', 'prim_sphere', 'cl
                          #oth_square', 'fluid_receptacle1m_round', 'ramp_with_platform', 'fluid_receptacle
                          #1x1', 'fluid_receptacle1x2', 'prim_capsule']
                          ...
                          {"$type": "scale_object",
                           "id": receptacle_id,
                           "scale_factor": {"x": 0.5, "y": 1.0, "z": 0.5}},
    ...
    def run(self, num_trials: int) -> None:
        for i in range(num_trials):
            ...
            fluid_name = random.choice([x for x in FLUID_TYPES.keys()])
