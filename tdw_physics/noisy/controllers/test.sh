...
# python3 noisy_dominoes.py --dir tmp --num 10 --height 500 --width 500 --framerate 60 --save_passes "_img" --save_movies --noise noise_null.json --read_trial_seed trial_seed.json