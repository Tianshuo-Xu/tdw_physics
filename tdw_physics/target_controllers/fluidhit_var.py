...
from tdw_physics.target_controllers.dominoes_var import MultiDominoes, get_args, none_or_str, none_or_int
...
class Drop(MultiDominoes):
    ...
    def __init__(self,
        ...
        self.set_container_types(CONTAINER_NAMES, libraries=["models_special.json"])
    ...
    def set_container_types(self, olist, libraries=["models_flex.json"]):
        tlist = self.get_types(olist, libraries=libraries, flex_only=self.flex_only)

        self._container_types = tlist
    ...
    def get_trial_initialization_commands(self, interact_id) -> List[dict]:
        ...
        if interact_id == 0:
            ...
            self.camera_aim = {"x": 0, "y": self.drop_height * 0.5, "z": 0}
    ...
    def _place_intermediate_object(self, interact_id) -> List[dict]:
        ...
        commands.extend([
            ...
            {"$type": "set_kinematic_state",
                     ...
                     "is_kinematic": True,
                     "use_gravity": True}])
        commands.extend([{"$type": "teleport_object", "position": {"x":0, "y":0.1, "z":0}, "id": o_id}])
        ...
        if interact_id > 0:
            ...
            # add the object
            rotation = self.get_rotation(self.target_rotation_range)
                ...
                {"$type": "scale_object",
                 ...
                 "id": o_id},
                    {"$type": "set_kinematic_state",
                         ...
                         "is_kinematic": True,
                         "use_gravity": True}])
            commands.extend([{"$type": "teleport_object", "position": {"x":0, "y":0, "z":0}, "id": o_id}])
