...
def get_parser(dataset_dir: str, get_help: bool=False):
    ...
    parser.add_argument("--dir", type=str, default=f"./dataset", help="Root output directory.")
    ...
    parser.add_argument("--width", type=int, default=512, help="Screen width in pixels.")
    parser.add_argument("--height", type=int, default=512, help="Screen width in pixels.")
