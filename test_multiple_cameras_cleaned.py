...
output_directory = str(EXAMPLE_CONTROLLER_OUTPUT_PATH.joinpath("send_images_0").resolve())
...
#         if images.get_avatar_id() == "a":
        TDWUtils.save_images(images=images, filename=str(i), output_directory=output_directory)
