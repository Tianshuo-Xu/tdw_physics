...
#for name in [name for name in f["frames"]['0000']["objects"]]:
print("positions")
print(f["frames"]['0000']["objects"]["positions"][:])

print("rotations")
print(f["frames"]['0000']["objects"]["rotations"][:])

print("scale")
print(f["static"]['scale'][:])

print("model_names")
print(f["static"]["model_names"][:])
